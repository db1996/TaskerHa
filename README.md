...
3. Open the app (outside of tasker) and fill in your Homeassistant server details. this works both over localhost and remote. Make sure you choose HTTPS or HTTP depending on what type of server you use.
